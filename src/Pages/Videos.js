...
function Videos() {
  ...
  const handleSubmit = async (event) => {
    ...
    setValidated(true);
    navigate(`/sensebridge-nexus/video/${videoId}`, { replace: false });
  };
      ...
      <div className="container-fluid text-white" style={{backgroundColor: 'rgba(9,9,121)'}}>
        <div className="container my-5">
          ...
          <div className="lead text-center">
            Welcome to the ISL video section of Sensebridge Nexus. Create your own public
        ...
        <div className="container">
          <div className="row my-4">
            ...
            >
              ...
              <Link to='/sensebridge-nexus/create-video' className="btn btn-primary mt-4">
